...
In the event that multiple claims are made fo the same short name, conflicts will be resolved in favor of the DNS name that has been registered for the longest, based on available Whois data.
